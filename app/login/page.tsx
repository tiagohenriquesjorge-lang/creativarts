...
import { signIn, getCurrentUser } from '@/lib/auth/customerAuth'
        ...
        <div className="bg-white rounded-lg border-2 border-brand-gray-light p-8 shadow-lg">
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-sm text-brand-gray-dark/70">
              Não tem conta?{' '}
              <Link href="/registo" className="text-brand-blue hover:underline font-medium">
                Criar conta
              </Link>
            </p>
            <Link
              href="/recuperar-password"
              className="block text-sm text-brand-gray-dark/70 hover:text-brand-blue hover:underline"
            >
